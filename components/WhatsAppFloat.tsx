...
const WHATSAPP_NUMBER = "971582366125"; // Update with your WhatsApp number
const WHATSAPP_MESSAGE = "Hi ZaadCore, I'd like to discuss a project.";
...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      style={{ background: "var(--accent)", boxShadow: "0 4px 24px rgba(249,115,22,0.35)" }}
    >
